<x-app-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="px-6 bg-white border-b border-gray-200">
            <x-components::form action="{{ route('customers.reviews.store', [$customer]) }}" method="post">
                <x-components::form.fieldset-top>
                    ...
                    <x-components::form.group-top-3>
                        ...
                        <x-components::form.date id="opens_at" name="opens_at" :value="old('opens_at')"/>
                    </x-components::form.group-top-3>
                    <x-components::form.group-top-3>
                        <x-components::form.label required
                                                  for="closes_at">{{ __('Closes at')  }}</x-components::form.label>
                        <x-components::form.date id="closes_at" name="closes_at" :value="old('closes_at')"/>
                    </x-components::form.group-top-3>
                    <x-components::form.group-top-3>
                        <x-components::form.label required
                                                  for="visible_at">{{ __('Results visible at')  }}</x-components::form.label>
                        <x-components::form.date id="visible_at" name="visible_at" :value="old('visible_at')"/>
                    </x-components::form.group-top-3>
                </x-components::form.fieldset-top>
