        ...
        <x-page-header>
            ...
            <x-slot name="actions">
                <x-button.big
                        ...
                        href="{{ route('customers.daily-questions.index', [$customer]) }}">{{ __('Questions') }}</x-button.big>
            </x-slot>
        </x-page-header>
    </x-slot>
                                        ...
                                        <x-components::grid cols="2" class="opacity-0 group-hover:opacity-100">
                                            ...
                                            <x-components::grid.block>
                                                <x-components::lists.button
                                                        py="0" px="2"
                                                        delete
                                                        href="{{ route('customers.daily-questions.templates.destroy', [$customer, $question->model->id]) }}">
                                ...
                                @if($question->model->id === $editingQuestion)
                                    <div>
                                        <x-components::form method="post"
                                                            action="{{ route('customers.daily-questions.templates.update', [$customer, $question->model]) }}">
                    ...
                    <div class="relative flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            @if($newQuestion)
                                ...
                                @if($newType)
                                    <x-components::form method="post"
                                                        action="{{ route('customers.daily-questions.templates.store', $customer) }}">
                                        <x-components::form.fieldset>
