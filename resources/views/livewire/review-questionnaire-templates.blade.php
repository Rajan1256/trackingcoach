<div>
        ...
        <x-page-header>
            ...
            <x-slot name="actions">
                <x-button.big
                        ...
                        href="{{ route('customers.reviews.index', [$customer]) }}">{{ __('Mini-survey') }}</x-button.big>
            </x-slot>
        </x-page-header>
    </x-slot>
    ...
    <div class="p-6 flow-root">
        ...
        <input type="text" class="rounded py-2 px-3 w-full mb-4" placeholder="Search templates"
                                        ...
                                        <x-components::grid cols="2" class="opacity-0 group-hover:opacity-100">
                                            ...
                                            <x-components::grid.block>
                                                <x-components::lists.button
                                                        py="0" px="2"
                                                        delete
                                                        href="{{ route('customers.reviews.questions.templates.destroy', [$customer, $question->model->id]) }}">
                                ...
                                @if($question->model->id === $editingQuestion)
                                    <div>
                                        <x-components::form method="post"
                                                            action="{{ route('customers.reviews.questions.templates.update', [$customer, $question->model]) }}">
                    ...
                    <div class="relative flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            @if($newQuestion)
                                ...
                                @if($newType)
                                    <x-components::form method="post"
                                                        action="{{ route('customers.reviews.questions.templates.store', $customer) }}">
                                        <x-components::form.fieldset>
