<x-app-layout>
    ...
    <div class="px-6">
        <x-components::form method="post" action="{{ route('consents.store') }}" enctype="multipart/form-data">
            <x-components::form.fieldset>
                ...
                <x-components::form.group-top>
                    ...
                    <x-components::form.textarea name="description"></x-components::form.textarea>
                </x-components::form.group-top>
                <x-components::form.group-top>
                    <x-components::form.label>{{ __('Confirmation text') }}</x-components::form.label>
                    <x-components::form.input name="confirmation_text"/>
                </x-components::form.group-top>
                <x-components::form.group-top>
