...
class QuestionnaireTemplates extends Component
{
    ...
    public function updateQuestionOrder($order)
    {
        ...
        Question::where('scope', 'tracklistTemplate')->sorted()->get()->each(function (Question $question) use (
            $newOrder
        ) {
    ...
    public function render()
    {
        ...
        return view('livewire.questionnaire-templates')
            ->with([
