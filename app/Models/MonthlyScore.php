...
class MonthlyScore extends Model implements TeamAware
{
    use HasFactory;
    use TeamAwareTrait;
    ...
    protected $fillable = [
        'team_id', 'user_id', 'days_per_week', 'question_id', 'question_history_id', 'score', 'month', 'year',
        'extra_data',
    ];
    ...
    public function scopeBetween(Builder $query, CarbonInterface $start, CarbonInterface $end)
    {
        return $query
